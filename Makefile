...
# TODO: stolen from project.mk -- merge?!
BID_PRJ_DIR_MAX_DEPTH := 4
find_pkg_dirs = $(shell $(L4DIR)/mk/pkgfind $(1) $(BID_PRJ_DIR_MAX_DEPTH))

# Kconfig.L4 files must be next to the Control file
PKG_KCONFIG_L4_FILES := $(wildcard $(addsuffix /Kconfig.L4,$(call find_pkg_dirs,$(SRC_DIR))))
...
Makeconf.bid.local-helper:
	...
	$(VERBOSE)$(foreach v, BID_COMPILER_TYPE GCCDIR GCCLIB_HOST GCCLIB_EH GCCLIB_S_SO \
			...
			GCCWNONOEXCEPTTYPE GCCWNOPSABI GCCSYSLIBDIRS GCCFORTRANAVAIL GCCLIBCAVAIL \
